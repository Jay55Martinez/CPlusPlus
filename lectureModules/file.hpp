...
namespace std1 {
    ...
    //void myFunction(int&); //by default, pass by ref
    //void myFunction(const int [][20]); //by default, pass by ref
    void myFunction(const int myVal[][20][30]); //by default, pass by ref
